    ...
    <Container>
      ...
      <List ml={4} my={4}>
        ...
        <ListItem>
          ...
          <Link href="https://speakerdeck.com/ac2dia/the-fun-deep-learning">
            The fun Deep Learning <ExternalLinkIcon mx="2px" />
          </Link>
        </ListItem>
        <ListItem>
          <Meta>Presentation</Meta>
          <Link href="https://speakerdeck.com/ac2dia/caffedeoshou-qing-ben-ge-deipuraninguiosapuri">
        ...
        <ListItem>
          <Meta>Source</Meta>
          <Link href="https://github.com/ac2dia/caffe-ios-sample">
            github.com/ac2dia/caffe-ios-sample <ExternalLinkIcon mx="2px" />
          </Link>
        </ListItem>
      </List>
